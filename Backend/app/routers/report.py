...
from app.services.intent_classifier import resolve_kb_category
...
def _build_report_data(case_id: str, db: Session) -> dict:
    ...
    legal_refs = search_kb(incident_summary, category=resolve_kb_category(case.category), top_k=3) if case.category else []
